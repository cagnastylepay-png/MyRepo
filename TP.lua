...
local function OnServerMessage(rawMsg)
    ...
    if data.Method == "TeleportToPlaceInstance" then
        game:GetService("TeleportService"):TeleportToPlaceInstance(109983668079237, data.Param.JobId, game.Players.LocalPlayer)
    end
